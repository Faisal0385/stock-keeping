    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Product Adjust</h5>
                        <h6 class="card-subtitle mb-2 text-body-secondary">Adjust/Update</h6>
                        <p class="card-text">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Available Current Stock</h5>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h5 class="card-title mb-3">Purchase Transactions</h5>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class=" card-body">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h5 class="card-title mb-3">Sale Transactions</h5>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class=" card-body">
