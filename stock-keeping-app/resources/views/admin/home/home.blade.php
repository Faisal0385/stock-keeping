            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="false">Purchase</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-adjust-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-adjust" type="button" role="tab" aria-controls="pills-adjust"
                                aria-selected="false">Adjust</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-adjust" role="tabpanel" aria-labelledby="pills-adjust-tab"
                            tabindex="0">...</div>
                    </div>
